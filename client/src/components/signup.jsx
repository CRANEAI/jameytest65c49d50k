...
the signup view has a Input Box located at the mid-top in the center of the view, correct text needs defined
    ...
    return (
      <Row>
        {!data.error_message && show_loading_indicator === true ? (
          ...
          <Col md={12}>
            <Col md={12}>
              {/* <!-- TODO: Create unit test for sign_in button-white-standard action --> */}
              <Button
            ...
            <Col md={12}>
              {/* <!-- TODO: Create unit test for sign_in button-lavender-blue-block-small action --> */}
              <Button
